...
root.resizable(0,0)
root.title("Touchless Controls")
label = tk.Label(root, text="Make Your Windows Touchless", fg="brown",font='TkDefaultFont 16 bold')
label.grid(row=0, columnspan=10, pady=10, padx=10)
image = ImageTk.PhotoImage(Image.open("tap2.jpg"))
...
start_button = tk.Button(root,text=" Track Mouse",fg="white", bg='blue', font='Helvetica 12 bold italic ',command= runvirtualmouse , height="4", width="16",activebackground='lightblue')
start_button.grid(row=1,column=1, pady=10, padx=10)

keyboard_img = ImageTk.PhotoImage(Image.open("keyboard1.jpeg"))
img_label_key = tk.Label(image=keyboard_img , width=100, height=100, borderwidth=3, relief="solid")
img_label_key.grid(row=2, column=0, pady=10, padx=10)

keyboard_button = tk.Button(root,text=" Keyboard",fg="white", bg='blue', font='Helvetica 12 bold italic ',command = runVirtualKeyboard , height="4", width="16",activebackground='lightblue')
keyboard_button.grid(row=2,column=1, pady=10, padx=10)
root.mainloop()
